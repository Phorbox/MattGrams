 ...
 * Carnivorous. It also contains getter and setter methods
 * this class can create a animal.
 * 
...
public class Animal {
	 ...
	 * @param AnimalDiet
	 */
	public Animal(String AnimalType, String AnimalName, boolean AnimalDiet) {
	...
	public String toString() {
		...
		return String.format("%s - %s (%s)", this.getType(), this.getName(), this.Meal());
	}
