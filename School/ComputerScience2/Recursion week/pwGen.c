...
// generateLine recursively fills and prints the lines by ending letter
void generateLine(char*, int, char*, int);

// passwordOptionsFills fills an array with the character options from user arguments
void passwordOptionsFill(char *, int, char**);

//generatates blocks of passwords by password length
